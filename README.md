...
```bash
git clone https://github.com/doomhyena/Frontend-portfolio.git
```

Follow the setup instructions in the individual project folders to configure the database and environment.
